...
function Dir() {
    if (fs.existsSync(`${(0, path_1.join)(exports._root, '..', 'plugins', 'permissions')}/package.json`))
        return (0, path_1.join)(exports._root, '..', 'plugins', 'permissions');
    if (fs.existsSync(`${(0, path_1.join)(exports._root, '..', 'plugins', 'permissions-main')}/package.json`))
        return (0, path_1.join)(exports._root, '..', 'plugins', 'permissions-main');
    return "../node_modules/@bdsx/permissions";
}
/**
 * print to console
